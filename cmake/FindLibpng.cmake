...
if(LIBPNG_INCLUDE_DIR)
  if(NOT LIBPNG_VERSION_STRING)
    ...
    string(
      REGEX REPLACE ".*#define PNG_LIBPNG_VER_STRING \"([0-9]+.[0-9]+.[0-9]+)\".*"
      "\\1"
...
find_package_handle_standard_args(
  ...
  REQUIRED_VARS LIBPNG_LIBRARY LIBPNG_INCLUDE_DIR ZLIB_FOUND LIBPNG_VERSION_STRING
)
