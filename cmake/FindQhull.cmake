...
if(NOT QHULL_LIBRARY)
  find_library(
    QHULL_LIBRARY
    NAMES ${GR_THIRDPARTY_LIBRARY_PREFIX}qhull_r${GR_THIRDPARTY_LIBRARY_SUFFIX} qhullstatic_r qhull_r
  )
endif()
...
if(NOT QHULL_VERSION_STRING AND QHULL_INCLUDE_DIR AND QHULL_LIBRARY)
  if(CMAKE_CROSSCOMPILING)
    ...
    try_compile(
      COMPILE_SUCCESS
      "${CMAKE_CURRENT_BINARY_DIR}/qhull_get_version"
      "${CMAKE_CURRENT_BINARY_DIR}/qhull_get_version.c"
