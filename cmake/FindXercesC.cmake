...
if(NOT XERCES_C_LIBRARY)
  find_library(
    XERCES_C_LIBRARY
    NAMES ${GR_THIRDPARTY_LIBRARY_PREFIX}xerces-c${GR_THIRDPARTY_LIBRARY_SUFFIX} xerces-c libxerces-c
  )
endif()
...
if(XERCES_C_INCLUDE_DIR)
  if(NOT XERCES_C_VERSION_STRING)
    ...
    string(
      REGEX REPLACE ".*#define XERCES_VERSION_MAJOR[ \t]*([0-9]+).*"
      "\\1"
      XERCES_C_VERSION_MAJOR
      ${XERCES_VERSION_H_TEXT}
    )
    string(
      REGEX REPLACE ".*#define XERCES_VERSION_MINOR[ \t]*([0-9]+).*"
      "\\1"
      XERCES_C_VERSION_MINOR
      ${XERCES_VERSION_H_TEXT}
    )
    string(
      REGEX REPLACE ".*#define XERCES_VERSION_REVISION[ \t]*([0-9]+).*"
      "\\1"
      XERCES_C_VERSION_REVISION
      ${XERCES_VERSION_H_TEXT}
    )
    string(
      CONCAT XERCES_C_VERSION_STRING
...
find_package_handle_standard_args(
  XERCES_C
  VERSION_VAR XERCES_C_VERSION_STRING
  REQUIRED_VARS XERCES_C_LIBRARY XERCES_C_INCLUDE_DIR XERCES_C_VERSION_STRING
)
...
if(XERCES_C_FOUND)
  ...
  if(NOT TARGET XercesC::XercesC)
    ...
    set_target_properties(
      XercesC::XercesC
      PROPERTIES
        INTERFACE_INCLUDE_DIRECTORIES "${XERCES_C_INCLUDE_DIRS}"
